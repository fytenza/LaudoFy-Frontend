...
const ResetarSenha = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErro(err.response?.data?.erro || 'Erro ao redefinir senha. O token pode ter expirado.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="w-full max-w-md px-6 py-8">
          <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200">
            <div className="text-center">
              ...
              <h1 className="text-2xl font-bold text-slate-800 mb-1">Token Inválido</h1>
              <p className="text-slate-500 text-sm mb-5">O link de recuperação está incompleto ou expirado.</p>
              <button 
      ...
      <div className="w-full max-w-md px-6 py-8">
        <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 text-sm">Digite e confirme sua nova senha</p>
          </div>
